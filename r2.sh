...
mkdir reads2
mythread=4  #change the thread each bowtie2 used
inputdir=. #input dictionary
input=CF3_S2_L002_R2_001_val_2.fq #input file, change as your input, fastq format
index=/public/home/lchen/v3.29_index/b2_index/ #change to your bismark index
outputdir=./reads2 #output dictionary
